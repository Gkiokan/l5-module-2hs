...
@section('content')
    ...
    <form action="{{ route('secondhandshop.customer.store') }}" method="POST" class='form-horizontal'>
        ...
        <div class='col-xs-12 col-sm-5'>
            ...
            <div class="form-group">
                ...
                <div class='col-sm-9'>
                    <input type='text' id='bday' class='form-control' name='bday' placeholder='dd.mm.yyyy' value='{{ old('bday') }}'>
                </div>
            </div>
        </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class='col-sm-9'>
                          <input type='text' id='email' class='form-control' name='email'
                                 placeholder="Info E-Mail adress of the company" value='{{ old('email') }}'>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class='col-sm-9'>
                          <input type='text' id='mobil' class='form-control' name='mobil'
                                placeholder="Company Mobil Number" value='{{ old('mobil') }}'>
                      </div>
                  </div>
            </div>
        </div>
